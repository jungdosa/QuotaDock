...
var lightPaletteColors = map[string]color.NRGBA{
	// "white" is a semantic account colour. On light surfaces it becomes a
	// cool charcoal so the meter remains visible instead of disappearing.
	"white": {0x35, 0x43, 0x54, 0xFF},

...
- **ライト · ダーク · システムテーマ**、12/24 時間の日付形式、プロバイダー別のカラーパレット、
  警告しきい値の設定
- **9 言語対応** —— 英語、韓国語、ドイツ語、フランス語、イタリア語、インドネシア語、
  ポルトガル語（ブラジル）、スペイン語（スペイン/ラテンアメリカ）。`システム` を選ぶと
  Windows の表示言語に従います
...
- **ログファイルを作りません。** ディスクにログを書きません。診断出力は標準エラーのみで、
  秘密情報・bearer トークン・メールアドレスはその前に伏せられます。
...
- Go 1.26 以上
- C コンパイラ（Windows: MinGW-w64 / macOS: Xcode Command Line Tools / Linux: gcc + X11 開発ヘッダー）
